...
class Routine(Base):
    ...
    days = relationship(
        "RoutineDay", back_populates="routine", cascade="all, delete-orphan"
    )
...
class RoutineDay(Base):
    ...
    exercises = relationship(
        "RoutineExercise", back_populates="day", cascade="all, delete-orphan"
    )
...
class RoutineExercise(Base):
    ...
    )  # Denormalized for simplicity, or if no catalog entry
