...
def test_get_me_with_complete_profile_simple(
    test_client: TestClient, user_with_profile_simple, auth_headers_simple
):
...
def test_get_me_without_profile_simple(
    test_client: TestClient, user_without_profile_simple
):
...
def test_put_me_profile_validation_errors_simple(
    test_client: TestClient, user_without_profile_simple
):
