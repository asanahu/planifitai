web-1     | INFO:     172.18.0.1:45188 - "GET /api/v1/progress?metric=workout&start=2025-09-03&end=2025-09-10 HTTP/1.1" 307 Temporary Redirect
db-1      | 2025-09-10 14:09:49.250 UTC [795] ERROR:  invalid input value for enum progressmetric: "workout" at character 442
db-1      | 2025-09-10 14:09:49.250 UTC [795] STATEMENT:  SELECT progress_entries.id AS progress_entries_id, progress_entries.user_id AS progress_entries_user_id, progress_entries.date AS progress_entries_date, progress_entries.metric AS progress_entries_metric, progress_entries.value AS progress_entries_value, progress_entries.unit AS progress_entries_unit, progress_entries.notes AS progress_entries_notes 
...
web-1     | INFO:     172.18.0.1:45188 - "GET /api/v1/progress/?metric=workout&start=2025-09-03&end=2025-09-10 HTTP/1.1" 500 Internal Server Error
web-1     | 
web-1     | Traceback (most recent call last):
...
web-1     | [parameters: {'user_id_1': 1, 'metric_1': 'workout', 'date_1': datetime.date(2025, 9, 3), 'date_2': datetime.date(2025, 9, 10)}]
web-1     | (Background on this error at: https://sqlalche.me/e/20/9h9h)
web-1     | INFO:     172.18.0.1:51632 - "POST /api/v1/ai/generate/workout-plan HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:51632 - "POST /api/v1/routines HTTP/1.1" 307 Temporary Redirect
web-1     | INFO:     172.18.0.1:51632 - "POST /api/v1/routines/ HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:51632 - "GET /api/v1/routines HTTP/1.1" 307 Temporary Redirect
web-1     | INFO:     172.18.0.1:51632 - "GET /api/v1/routines/ HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:39648 - "OPTIONS /api/v1/routines/exercise-catalog?limit=1 HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:39664 - "GET /api/v1/notifications?date=2025-09-10&state=scheduled%7Csent_today HTTP/1.1" 307 Temporary Redirect
web-1     | INFO:     172.18.0.1:39660 - "GET /api/v1/users/me HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:39648 - "GET /api/v1/routines/exercise-catalog?limit=1 HTTP/1.1" 200 OK
web-1     | INFO:     172.18.0.1:39664 - "GET /api/v1/notifications/?date=2025-09-10&state=scheduled%7Csent_today HTTP/1.1" 200 OK